...
func buildNodeModel(node *v1.Node, metrics *metricsv1beta1.NodeMetrics, pods *v1.PodList) *models.Node {
	...
	nodeModel := &models.Node{
		...
		CPU: models.ResourceMetric{
			Capacity:       cpuCapacity.AsApproximateFloat64(), // CPU: 核心数
		...
		Memory: models.ResourceMetric{
			Capacity:       memCapacity.AsApproximateFloat64() / 1024 / 1024, // 内存: Mi
			Allocatable:    memAllocatable.AsApproximateFloat64() / 1024 / 1024,
			Allocated:      memAllocated.AsApproximateFloat64() / 1024 / 1024,
			Used:           memUsed.AsApproximateFloat64() / 1024 / 1024,
			Utilization:    memUtilization,
			AllocationRate: memAllocationRate,
		},
		EphemeralStorage: models.ResourceMetric{
			Capacity:       storageCapacity.AsApproximateFloat64() / 1024 / 1024, // 存储: Mi
			Allocatable:    storageAllocatable.AsApproximateFloat64() / 1024 / 1024,
			Allocated:      storageAllocated.AsApproximateFloat64() / 1024 / 1024,
			Used:           storageUsed.AsApproximateFloat64() / 1024 / 1024,
