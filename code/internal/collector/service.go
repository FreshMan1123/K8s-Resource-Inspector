...
func (c *ServiceCollector) GetServices(ctx context.Context, namespace string) ([]*ServiceInfo, error) {
...
// buildServiceInfo 构建完整的 ServiceInfo
func (c *ServiceCollector) buildServiceInfo(ctx context.Context, service *corev1.Service) (*ServiceInfo, error) {
	...
	if len(service.Spec.Selector) > 0 {
		...
		if err != nil {
			return nil, fmt.Errorf("获取匹配的 Pod 失败: %w", err)
		}
...
func (c *ServiceCollector) getEndpointsForService(ctx context.Context, service *corev1.Service) ([]EndpointInfo, error) {
...
func (c *ServiceCollector) getMatchingPods(ctx context.Context, service *corev1.Service) ([]PodInfo, error) {
